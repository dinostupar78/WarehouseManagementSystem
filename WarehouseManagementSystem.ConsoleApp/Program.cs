...
var purchaseOrders = new List<PurchaseOrder>
{
    new PurchaseOrder
    {
        ...
        Status = OrderStatus.Shipped, Supplier = suppliers[0],
    ...
    new PurchaseOrder
    {
        ...
        Status = OrderStatus.Shipped, Supplier = suppliers[1],
...
var supplierWithHighestOrderValue = suppliers
    ...
    {
        supplier.Name,
        TotalOrderValue = supplier.PurchaseOrders.Sum(order => order.TotalAmount)
    })
