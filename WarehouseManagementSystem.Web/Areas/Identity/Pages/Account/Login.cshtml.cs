...
namespace WarehouseManagementSystem.Web.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        private const string GuestEmail = "guest@wms.local";
        ...
        public async Task<IActionResult> OnPostGuestAsync(string returnUrl = null)
        {
            ...
            else if (guestUser.UserName != GuestUsername)
            {
                await _userManager.SetUserNameAsync(guestUser, GuestUsername);
            }

            if (!await _userManager.IsInRoleAsync(guestUser, GuestRole))
            {
